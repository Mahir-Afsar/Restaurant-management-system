...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"style="padding-top: 10px">
    ...
    <img src="../Admin/View/image/reg.jpg" width=200px alt="Avatar" class="avatar">
    </div>

    <div class="container" style="background-color:#FAF0E6">

    <p><b><a class="two" href="../Admin/View/registration.php">Register as User</a></b></p>
    <p><b><a class="two" href="../Admin/View/registration2.php">Register as Employee</a></b></p>
